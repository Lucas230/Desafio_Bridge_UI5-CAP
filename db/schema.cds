...
entity Vagas : cuid{
    ...
    participantes: Association to many Vagas_Participantes on participantes.vagas = $self;
}
...
entity Participantes : cuid{
    ...
    dt_fim: Date;
    curso: String(50);
    vagas: Association to many Vagas_Participantes on vagas.participantes = $self;
}